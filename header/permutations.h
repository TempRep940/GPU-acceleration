...
IMPORTANT_FUNCTION static inline void P12(state_t* s) {
...
IMPORTANT_FUNCTION static inline void P8(state_t* s) {
  printstate(" permutation input", s);
  ROUND(s, 0xb4);
  ROUND(s, 0xa5);
  ROUND(s, 0x96);
...
IMPORTANT_FUNCTION static inline void P6(state_t* s) {
  printstate(" permutation input", s);
  ROUND(s, 0x96);
  ROUND(s, 0x87);
  ROUND(s, 0x78);
